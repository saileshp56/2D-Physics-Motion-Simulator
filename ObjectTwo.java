...
public class ObjectTwo{
	...
	public ObjectTwo(double mass, double positionX, double positionY, double velocityX, double velocityY) {
	this.mass = mass;
	...
	public ObjectTwo(double forceX, double forceY, double time) {
